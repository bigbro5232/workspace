...
class Account {
    ...
    // 전체 출력문
    toString() {
        return console.log(`${this.number},${this.owner},${this.password},${this.balance}`);
    }
}
...
const minusAccount = new MinusAccount("1111-2222", "이재명", 123, 10000, 0);
account.toString();
minusAccount.withdraw(5000);
minusAccount.toString();
minusAccount.getBalance();
minusAccount.withdraw(100000);
minusAccount.toString();
minusAccount.getBalance();